...
# $Header: /var/cvsroot/gentoo-x86/mail-filter/spamassassin/spamassassin-3.1.0-r1.ebuild,v 1.12 2006/03/14 01:55:33 gustavoz Exp $
...
LICENSE="Apache-2.0"
SLOT="0"
#KEYWORDS="~alpha ~amd64 ~hppa ~ia64 ~ppc ~ppc64 ~sparc ~x86 ~mips x86-sunos"
KEYWORDS="~alpha ~hppa ~ppc ~ppc64 ~sparc ~x86 -x86-sunos"
