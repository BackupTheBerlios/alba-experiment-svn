...
# $Header: /var/cvsroot/gentoo-x86/sys-devel/libperl/libperl-5.8.7.ebuild,v 1.24 2006/01/15 10:23:07 tove Exp $
...
src_unpack() {
	...
	#
	cd ${S};
	use userland_Darwin || [[ ${USERLAND} == "SunOS" ]]  || epatch ${FILESDIR}/${PN}-create-libperl-soname.patch
...
src_compile() {
	...
	#use userland_SunOS && myconf="${myconf} -B/usr/ccs/bin"
	einfo `which ld`
