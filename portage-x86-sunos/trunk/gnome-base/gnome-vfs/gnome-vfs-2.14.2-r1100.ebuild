...
# $Header: /var/cvsroot/gentoo-x86/gnome-base/gnome-vfs/gnome-vfs-2.14.2.ebuild,v 1.7 2006/07/17 18:01:40 dang Exp $
...
SLOT="2"
KEYWORDS="~alpha amd64 ~arm hppa ppc ~ppc64 ~sh sparc x86 x86-sunos"
...
src_unpack() {
	...
	use x86-sunos && epatch ${FILESDIR}/gnome-vfs-2.14.1-sunos-missing_login_tty.patch
