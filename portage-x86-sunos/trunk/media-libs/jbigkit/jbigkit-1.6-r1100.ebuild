...
# $Header: /var/cvsroot/gentoo-x86/media-libs/jbigkit/jbigkit-1.6-r1.ebuild,v 1.16 2006/04/16 12:02:42 flameeyes Exp $
...
src_unpack() {
	...
	if use sun-ld ; then 
		epatch "${FILESDIR}"/${P}-shared-lib-sun-ld.patch
	else
