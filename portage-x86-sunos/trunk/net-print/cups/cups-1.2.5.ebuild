...
LICENSE="GPL-2"
SLOT="0"
KEYWORDS="~amd64 ~arm ~hppa ~ia64 ~m68k ~mips ~ppc ~ppc64 ~s390 ~sh ~sparc ~x86 ~x86-fbsd ~x86-sunos"
...
src_unpack() {
	...
	epatch ${FILESDIR}/cups-1.2.5.patch

	# cups does not use autotools "the usual way" and ship a static config.h.in
	eaclocal
	eautoconf
	epatch ${FILESDIR}/cups-1.2.5.solaris-configure.patch
}
