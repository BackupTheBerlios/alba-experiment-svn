...
# $Header: /var/cvsroot/gentoo-x86/sys-devel/libtool/libtool-1.5.22.ebuild,v 1.10 2006/03/30 14:10:56 flameeyes Exp ${P}-r1.ebuild,v 1.8 2002/10/04 06:34:42 kloeri Exp $
...
gen_ltmain_sh() {
	...
	eval `grep '^[[:space:]]*PACKAGE=' configure` && \
	eval `grep '^[[:space:]]*VERSION=' configure` && \
