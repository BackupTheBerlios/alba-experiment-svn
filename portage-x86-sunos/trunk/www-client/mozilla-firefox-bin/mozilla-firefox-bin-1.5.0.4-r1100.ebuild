...
# $Header: /var/cvsroot/gentoo-x86/www-client/mozilla-firefox-bin/mozilla-firefox-bin-1.5.0.4.ebuild,v 1.3 2006/07/07 21:24:18 genstef Exp $
...
SRC_URI="
      x86? (http://ftp.mozilla.org/pub/mozilla.org/firefox/releases/${PV}/linux-i686/en-US/firefox-${PV}.tar.gz)
      x86-sunos? (http://ftp.mozilla.org/pub/mozilla.org/firefox/releases/${PV}/contrib/solaris_tar_ball/firefox-${PV}.en-US.solaris2.10-i386.tar.bz2)"
