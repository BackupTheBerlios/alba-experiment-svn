...
# $Header: /var/cvsroot/gentoo-x86/net-p2p/azureus-bin/azureus-bin-2.3.0.6.ebuild,v 1.4 2006/09/02 16:15:41 blubb Exp $
...
SRC_URI="mirror://gentoo/seda-${MY_DT}.zip
	...
	x86-sunos? ( mirror://sourceforge/${MY_PN}/Azureus_${MY_PV}_Solaris.tar.bz2 )"
