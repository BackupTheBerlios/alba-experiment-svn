...
# $Header: /var/cvsroot/gentoo-x86/mail-client/mozilla-thunderbird-bin/mozilla-thunderbird-bin-1.5.0.2.ebuild,v 1.1 2006/04/20 00:15:13 anarchy Exp $

inherit eutils mozilla-launcher multilib

DESCRIPTION="The Mozilla Thunderbird Mail & News Reader"
SRC_URI="
	x86? (http://ftp.mozilla.org/pub/mozilla.org/thunderbird/releases/${PV}/linux-i686/en-US/thunderbird-${PV}.tar.gz)
	x86-sunos?  (http://ftp.mozilla.org/pub/mozilla.org/thunderbird/releases/${PV}/contrib/solaris_tar_ball/thunderbird-${PV}.en-US.solaris2.10-i386.tar.bz2)"
