...
inherit flag-o-matic eutils multilib toolchain-funcs mono libtool elisp-common gnuize
...
src_compile() {
	...
	use sun-ld && export gl_cv_cc_visibility="no"
...
src_install() {
	...
	use g-prefix || dosym msgfmt /usr/bin/gmsgfmt #43435
