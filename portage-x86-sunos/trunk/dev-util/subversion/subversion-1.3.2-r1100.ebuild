...
# $Header: /var/cvsroot/gentoo-x86/dev-util/subversion/subversion-1.3.2-r1.ebuild,v 1.8 2006/07/30 19:28:32 dang Exp $
...
#	use java && myconf="${myconf} $(use_with jikes)"
	...
	# I18n linking fix for Solaris. Solaris has external i18n library
	# flistello at gmail dot com
