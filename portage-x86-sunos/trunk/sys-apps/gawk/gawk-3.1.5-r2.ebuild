...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/gawk/gawk-3.1.5-r2.ebuild,v 1.15 2006/11/05 09:13:06 grobian Exp $
...
src_unpack() {
	...
	use sun-ld && sed -i 's/-Wl,-soname -Wl,$(TARGET).so.$(MAJORVER)//' "${SFFS}"/Makefile
}
