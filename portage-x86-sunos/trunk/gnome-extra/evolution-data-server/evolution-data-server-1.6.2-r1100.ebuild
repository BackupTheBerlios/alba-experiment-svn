...
# $Header: /var/cvsroot/gentoo-x86/gnome-extra/evolution-data-server/evolution-data-server-1.6.2.ebuild,v 1.7 2006/07/17 17:52:46 dang Exp $
...
IUSE="doc ipv6 kerberos krb4 ldap nntp ssl openldap-alternate-prefix"
...
pkg_setup() {
	...
	if use openldap-alternate-prefix; then
		G2CONF="${GCONF} \
				$(use_with ldap openldap=/usr/openldap)"
	else
		G2CONF="${GCONF} \
